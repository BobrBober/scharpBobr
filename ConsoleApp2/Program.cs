...
class Program
{
    static void Main()
    {
        ...
        {
            new Toy { Name = "Lego set", Price = 49.99m, AgeGroup = "6-12" },
            new Meat { Name = "Beef Steak", Price = 12.99m, ExpirationDate = DateTime.Now.AddDays(7) },
            new Drink { Name = "Orange Juice", Price = 3.49m, Volume = 1.5 },
            new Book { Name = "My-My", Price = 29.99m, Author = "John Doe" },
            new Electronics { Name = "Iphone", Price = 699.99m, WarrantyPeriod = 24 }
        };
